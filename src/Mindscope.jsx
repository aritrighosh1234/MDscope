    ...
    <div className="wa-fab-wrapper">
      ...
      <a href={url} target="_blank" rel="noopener noreferrer" className="wa-fab" aria-label="Chat on WhatsApp">
        ...
        <div className="wa-label">
          Book now &amp; get <strong>25% off</strong>
          <span>on your first consultation</span>
          <button
            className="wa-close"
            onClick={(e) => {
              e.stopPropagation();
          ...
          <div className="contact-form-wrap reveal-right">
            {sent ? (
              ...
              <form onSubmit={submit} noValidate>
                ...
                <button type="submit" className="form-submit">Enquire <br /><span className="small">25% off on First Consultation</span></button>
              </form>
            )}
          </div>
        </div>
